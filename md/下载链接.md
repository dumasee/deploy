...
脚本下载链接
```
wget -c http://111.0.121.226:3080/linux/prometheus/node_exporter-1.1.1.linux-amd64.tar.gz
wget -c http://111.0.121.226:3080/linux/prometheus/grafana-7.4.2.linux-amd64.tar.gz
